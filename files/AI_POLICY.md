...
This project permits AI-assisted development.

AI tools may be used to help draft code, tests, documentation, commit messages,
issue text, and pull request descriptions.

Any material created with AI assistance must be reviewed by the submitter before
submission.
